<template>
    <button class="button button-primary-main submit-button" :disabled="disabled" @click="submit" :class="{showInfoMessage: submissionInfo}" ref="submitButton">
        <span><slot></slot></span>
        <div class="button-group">
            <div class="info button button-primary-main button-icon" ref="info">
...
<style lang="scss">
    ...
    .button-primary-main.submit-button {
        position: relative;
        overflow: hidden;
